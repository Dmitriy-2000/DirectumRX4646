...
namespace Sungero.Contracts.Functions
{
  internal static class IncomingInvoice
  {
    ...
    {
      var __funcType = Sungero.Metadata.Services.AppliedTypesManager.Instance.Resolve("Sungero.Contracts.Client.IncomingInvoiceFunctions");
      if (__funcType != null)
      {    
        var __funcMethod = __funcType.GetMethod("FillContractFromLeadingDocument",
          System.Reflection.BindingFlags.Static | System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.NonPublic,
          null, new System.Type[] { typeof(global::Sungero.Docflow.IOfficialDocument), typeof(global::Sungero.Docflow.IContractualDocumentBase) }, null);
    global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(__funcMethod, null, new object[] { convertedDoc, contract });
      }
      else
      {
