...
namespace Sungero.SmartProcessing.Shared.VerificationAssignment
{
  ...
  public class VerificationAssignmentResources : global::Sungero.Workflow.Shared.Assignment.AssignmentResources, global::Sungero.SmartProcessing.VerificationAssignment.IVerificationAssignmentResources
  {
    ...
    public virtual global::CommonLibrary.LocalizedString NoLicenseToRepaсking
    {
      get
      {
        return global::Sungero.Domain.Shared.ResourceService.Instance.GetEntityStringResource(typeof(Sungero.SmartProcessing.IVerificationAssignment) , "NoLicenseToRepaсking");
      }
    }

    public virtual global::CommonLibrary.LocalizedString NoLicenseToRepaсkingFormat(params object[] args)
    {
      return global::Sungero.Domain.Shared.ResourceService.Instance.GetEntityStringResource(typeof(Sungero.SmartProcessing.IVerificationAssignment), "NoLicenseToRepaсking", false, args);
    }
