  ...
  internal static class Bank
  {
    ...
    internal static  global::System.Collections.Generic.List<global::System.Int32> GetBankIdsServer()
    {
      ...
      {    
        ...
        return (global::System.Collections.Generic.List<global::System.Int32>)global::CommonLibrary.ReflectionExtensions.ReflectionInvoke(__funcMethod, null, new object[] {  });
      }
      else
      {
    ...
    internal static  global::System.String GetBankWithSameBicWarning(global::Sungero.Parties.IBank bank)
    {
      ...
      var __funcMethod = __functions.GetType().GetMethod("GetBankWithSameBicWarning", new System.Type[] {  });
